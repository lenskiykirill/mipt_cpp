...
dst::fenwick<unsigned long long> my_fenwick_function (
                                                      dst::fenwick<unsigned long long> a,
                                                      dst::fenwick<unsigned long long> b
                                                     ) {
      
}

struct fir_fenwick {
      dst::fenwick<dst::fenwick<unsigned long long>, dst::fenwick<unsigned long long> (*) (dst::fenwick<unsigned long long>, dst::fenwick<unsigned long long>)> F;
      dst::
};
